...
This site uses cookies to identify who is logged in, and google analytics uses cookies to record anonymized browsing behaviour.</p>
                ...
                <p className="m-4">This site is designed to educate and entertain. It's provided "as is", without any warranty or condition, express or implied or statutory. This site specifically disclaims any implied warranties of merchantability or fitness for a particular purpose.
